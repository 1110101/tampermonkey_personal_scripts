	...
	},
	{
		...
		languageOptions: {
			...
			globals: {
				...
				// Tampermonkey/Greasemonkey specific globals
		...
		rules: {
			...
			'no-console': 'off', // Allow console.log for debugging in userscripts
			'no-alert': 'warn' // Allow alert for notifications (with warning)
		}
	}
];
